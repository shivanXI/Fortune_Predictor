...
// Data points
d3.json('y77d-th95.geojson', function(json) {
    ...
    .enter()
      ...
      .on('mouseover', function(d) {
        ...
        div.transition()
          .duration(200)
          .style('opacity', .9);
        div.html( '<span class="def">School:</span> ' + '<span>Amridge University</span>' + '<br>' + 
                  '<span class="def">City:</span> ' + d.properties.name + '<br>' + 
                  '<span class="def">Average:</span> ' + d.properties.mass + '<br>' )
